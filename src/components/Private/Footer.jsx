...
const Footer = () => {
    return (
        <footer>
            <a className='site-link' href='https://myanimelist.netlify.app/'>
                MyAnimeList.netlify.app
            </a>
            <div>
            <ul>
                <li><a href='https://myanimelist.netlify.app/'>Donate</a></li>
                <li><a href='https://myanimelist.netlify.app/'>MyAnimeList.netlify.app</a></li>
